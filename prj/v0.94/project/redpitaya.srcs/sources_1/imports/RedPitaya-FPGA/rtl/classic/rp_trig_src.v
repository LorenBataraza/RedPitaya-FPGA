...
always @(posedge adc_clk_i) begin
   case (set_trig_src & ({4{!adc_trg_dis}}))
       ...
       4'd14: adc_trig <= adc_trig_p_i[0] | adc_trig_p_i[1] | trig_ch_i[0] | trig_ch_i[2] ; // Posedge Mega-OR
       4'd15: adc_trig <= adc_trig_n_i[0] | adc_trig_n_i[1] | trig_ch_i[1] | trig_ch_i[3] ; // Nededge Mega-OR
...
always @(posedge adc_clk_i) begin
   case (set_trig_src & ({4{!adc_trg_dis}}))
       ...
       // Multiple trigger source
       4'd14: adc_trig <= trig_ch_i[0] | trig_ch_i[2] | adc_trig_p_i[0] | adc_trig_p_i[1] ; //  Posedge Mega-OR
       4'd15: adc_trig <= trig_ch_i[1] | trig_ch_i[3] | adc_trig_n_i[0] | adc_trig_n_i[1] ; // A-ch negedge or B-ch negedge
