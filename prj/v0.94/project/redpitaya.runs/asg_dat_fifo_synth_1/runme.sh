...
HD_PWD='/home/lorenzo/PI/RedPitaya-FPGA/prj/v0.94/project/redpitaya.runs/asg_dat_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log asg_dat_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source asg_dat_fifo.tcl
