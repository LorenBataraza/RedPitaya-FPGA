...
Ejemplos:
    python3 campanas/run_acquire.py --duration 60 --thr 0.2
    python3 campanas/run_acquire.py --events 100000 --pre 8 --post 24 --out /mnt/datos
    python3 campanas/run_acquire.py --duration 30 --fake     # sin HW, para probar el flujo
"""
import argparse
import os
import signal
