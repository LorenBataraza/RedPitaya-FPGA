...
apilamiento (`monte-carlo/`) usa para discriminar eventos apilados: las dos
campañas miden la misma cantidad por motivos distintos.
    ...
    python3 campanas/graficar_formas.py --out DIR
    python3 campanas/graficar_formas.py --fwhm 4e-6      # otra consigna de ancho
    python3 campanas/graficar_formas.py --vpp 1.0
"""
import argparse
import glob
import os
