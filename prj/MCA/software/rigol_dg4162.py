...
testbenches, en `monte-carlo/pileup.py` y en los notebooks. Código nuevo::
...
# `monte-carlo/pileup.py` importa `_fwhm_pts` y llama `_escala_para_fwhm`, y
# tres tests más usan `rg._fwhm_pts`. Sin estas líneas el shim los pierde en
# silencio. `API/tests/gen_compat_baseline.py:privados_usados_fuera()` los detecta
