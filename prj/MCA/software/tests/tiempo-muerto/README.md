...
|---|---|---|
| [`plot_modelos_tasa.py`](plot_modelos_tasa.py) | las dos figuras: tasas medidas, ajuste y residuos | PC, sin placa |
...
[`arquitectura_adquisicion_software.md`](../../../docs/multitrigger/arquitectura_adquisicion_software.md),
...
[`poisson_train_wave`](../../rigol_dg4162.py) (sortea `N ~ Poisson(λT)` y pone
