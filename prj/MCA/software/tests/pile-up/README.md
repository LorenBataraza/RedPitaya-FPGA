...
[`limites_resolucion_y_deriva.md`](../../../docs/mca/limites_resolucion_y_deriva.md)
...
[`resultados_validacion_hw.md §4`](../../../docs/resultados_validacion_hw.md).
Está como test [15].
...
[`tests/formas/`](../formas/) grafica en volts contra tiempo las **seis familias
