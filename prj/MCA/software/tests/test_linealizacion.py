...
sys.path.insert(0, os.path.join(AQUI, 'estimadores'))

import mca_utils as mu

FAILS = []

DIR_CHUNKS = os.path.join(AQUI, '..', 'datos', 'e2e_20260528_013404', 'principal')
NPZ_CAMPANA = os.path.join(AQUI, '..', 'datos', 'mca_gate_esp_v2',
