# Plan de verificación — multitrigger

DUT principal: `multitrigger_cfg`

## Cómo se corre

```
make -C modulos/multitrigger/work          # todos los testbenches
make -C modulos/multitrigger/work <tb>     # uno solo
make -C modulos/multitrigger/work cov      # + cobertura, reporte en work/cov/html/
make -C modulos/multitrigger/work wave TB=<tb>   # ondas ya grabadas del último batch
```
