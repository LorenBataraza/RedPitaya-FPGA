// Assertions de multitrigger_cfg, enganchadas por `bind` desde sim/sva/bind_multitrigger.sv.
//
...
module multitrigger_cfg_sva (
  ...
  // TODO: propiedades de multitrigger. Arrancar por las invariantes que el testbench
