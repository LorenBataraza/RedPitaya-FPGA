...
# la del laboratorio. El lint que corre local es `make -C modulos/multitrigger/work lint`,
...
new_project multitrigger -projectwdir ${MOD_DIR}/lint/work -force
...
set_option top multitrigger_cfg
read_file -type sgdc ${MOD_DIR}/lint/multitrigger.sgdc
if {[file exists ${MOD_DIR}/lint/multitrigger.swl]} {
    read_file -type waiver ${MOD_DIR}/lint/multitrigger.swl
}
