...
# la del laboratorio. El lint que corre local es `make -C modulos/osc/work lint`,
...
new_project osc -projectwdir ${MOD_DIR}/lint/work -force
...
set_option top osc_cfg
read_file -type sgdc ${MOD_DIR}/lint/osc.sgdc
if {[file exists ${MOD_DIR}/lint/osc.swl]} {
    read_file -type waiver ${MOD_DIR}/lint/osc.swl
}
