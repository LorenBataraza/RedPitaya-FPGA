// COPIA CONGELADA de prj/MCA/rtl/osc_filter.v ANTES del redisenio de timing.
// Solo se usa en tb_osc_filter.sv como referencia dorada: el filtro nuevo tiene
// que dar EXACTAMENTE los mismos bits. No se sintetiza.

`timescale 1ns / 1ps

module osc_filter_ref
  #(parameter DW = 16)(
  input  wire         clk,  
  input  wire         rst_n,    
  // Slave AXI-S
