// Assertions de integration_cfg, enganchadas por `bind` desde sim/sva/bind_comun.sv.
//
...
module integration_cfg_sva (
  ...
  // TODO: propiedades de comun. Arrancar por las invariantes que el testbench
