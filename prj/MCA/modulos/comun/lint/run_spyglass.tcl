...
# la del laboratorio. El lint que corre local es `make -C modulos/comun/work lint`,
...
new_project comun -projectwdir ${MOD_DIR}/lint/work -force
...
set_option top integration_cfg
read_file -type sgdc ${MOD_DIR}/lint/comun.sgdc
if {[file exists ${MOD_DIR}/lint/comun.swl]} {
    read_file -type waiver ${MOD_DIR}/lint/comun.swl
}
