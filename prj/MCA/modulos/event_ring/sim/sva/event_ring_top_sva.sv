// Assertions de event_ring_top, enganchadas por `bind` desde sim/sva/bind_event_ring.sv.
//
...
module event_ring_top_sva (
  ...
  // TODO: propiedades de event_ring. Arrancar por las invariantes que el testbench
