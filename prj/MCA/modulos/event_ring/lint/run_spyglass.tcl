...
# la del laboratorio. El lint que corre local es `make -C modulos/event_ring/work lint`,
...
new_project event_ring -projectwdir ${MOD_DIR}/lint/work -force
...
set_option top event_ring_top
read_file -type sgdc ${MOD_DIR}/lint/event_ring.sgdc
if {[file exists ${MOD_DIR}/lint/event_ring.swl]} {
    read_file -type waiver ${MOD_DIR}/lint/event_ring.swl
}
