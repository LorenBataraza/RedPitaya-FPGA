...
que usa la campaña de INL vs forma, [`run_formas.py`](../../software/campanas/run_formas.py).

**Corre en la PC, sin placa y sin Rigol.**

```bash
python3 campanas/graficar_formas.py                 # a datos/formas_<la más reciente>
python3 campanas/graficar_formas.py --fwhm 4e-6     # otra consigna de ancho
python3 campanas/graficar_formas.py --vpp 1.0 --out /tmp
```
...
([`shaped_train_wave`](../../software/rigol_dg4162.py) con `n_pulses=1`). No es un dibujo
...
cociente Q/pico** que [`monte-carlo/`](../../software/monte-carlo/) usa para discriminar
...
[`pico_vs_carga.py`](../../software/monte-carlo/pico_vs_carga.py) lleva esto al plano donde la
